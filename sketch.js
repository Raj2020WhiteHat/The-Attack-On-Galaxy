...
function preload(){ 
  ...
  bkgI = loadImage("fffffffffffffff.jpg");
  ...
  if( score >= 10000){
    ...
    if(frameCount % 20 ===0)
      ...
      if(arrowGroup.isTouching(boss)){
        victory = createSprite(400,250,800,500);
        victory.addImage(vic);
        victory.scale = 3.5;
        boss.visible = false;
      }
     }
...
function arrowAttack5() {
  var arrow5 = createSprite(random(50,700),random(10,40), 10, 10);
  arrow5.addImage(arrow5I);
